  ...
  <body>
    ...
    <footer style="background: #111;">
        ...
        <div class="row py-5">
            ...
            <div class="d-flex align-items-center mb-3"><img src=" {{asset('frontend/img/logo-footer.svg')}} " alt="" width="30"><span class="text-uppercase text-small font-weight-bold text-white ml-2">Listings</span></div>
